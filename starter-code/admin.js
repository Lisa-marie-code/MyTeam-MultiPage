    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            <div class="director__info">
                ...
                <svg id="delDir${result[i].dir_id}" width="37" height="40" viewBox="0 0 37 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p for = "delDir${result[i].dir_id}" class="delete__director">
                Delete
                </p>  
            </div>
...
$('#addDirPhoto').change(function(e){
    ...
    // alert('The file "' + photoName +  '" has been selected.');
});
